<div>
    <div class ="relative mt-3 md:mt-0">
        <input wire:model.debounce.500ms = "search" type ="text" class ="text-sm  bg-gray-800 rounded-full w-64 py-1 pl-8 px-4 focus:outline-none focus:shadow-outline" placeholder ="Search"/>
